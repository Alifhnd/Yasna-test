...
return [
     ...
     "feed" => [
          ...
          'showing_x_numbers_out_of_total'  => "در حال نمایش :x سطر از مجموع :total سطر موجود اطلاعات",
          'hard_delete_notice'              => "این حذف غیر قابل بازگشت است. اطلاعات حذف‌شده، برای همیشه از بین خواهند رفت.",
     ],
     ...
     "button" => [
          ...
          'seeder_cheat'      => "تقلب سیدر",
          'copy_to_clipboard' => "کپی کن به کلیپ بورد",
     ...
     'data_type' => [
          ...
          'array'        => 'لیست',
          'file'         => "فایل",
          'combo'        => "فهرست کرکره‌ای",
          "color-picker" => "رنگ‌بردار",
