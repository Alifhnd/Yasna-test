...
return [
    ...
    */
    ...
    'javascript_validation' => [
         ...
         "telephone"            => 'تلفن ثابت ۱۱ رقمی خود را وارد نمایید.',
         "tel_emergency"        => 'تلفن اضطراری ۱۱ رقمی خود را وارد نمایید.',
         "postal_code"          => "کد پستی خود را به درستی وارد کنید.",
         "address"              => "نشانی پستی را با حروف فارسی وارد نمایید.",
         "tel"                  => "تلفن ۱۱ رقمی خود را وارد نمایید.",
         ...
         "home_postal"          => "کد پستی منزل را به درستی وارد کنید.",
         ...
         "work_postal"          => "کد پستی محل کار را به درستی وارد کنید.",
         "job"                  => "شغل را با حروف فارسی وارد نمایید",
         "familization"         => "نحوه‌ی آشنایی را انتخاب نمایید.",
         "familiarization"      => "نحوه‌ی آشنایی را انتخاب نمایید.",
         ...
         'name'                 => 'نام و نام خانوادگی را با حروف فارسی وارد کنید.',
         'min'                  => 'طول عبارت مناسب نیست.',
         'receiver'             => "دریافت‌کننده را به درستی وارد کنید.",
    ],
    ...
    */
    ...
    'attributes' => [
         ...
         'validation_rules' => "اعتبارسنجی",
         'purifier_rules'   => "پالایه",
         'color'            => "رنگ",
    ...
    "http" => [
         ...
         'Error424' => "متأسفیم ولی ظاهراً باید با برنامه‌نویس‌ها تماس بگیرید.",
         'Error500' => "بروز مشکل در سرور",
    ],
