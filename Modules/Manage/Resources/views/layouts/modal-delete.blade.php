@include("manage::layouts.modal-start" , [
	...
	'modal_title' => isset($modal_title)? $modal_title : trans('manage::forms.button.soft_delete'),
	'no_validation' => true ,
])
<div class='modal-body'>
	...
	@include('manage::forms.buttons-for-modal' , [
		'save_label' => isset($save_label)? $save_label : trans('manage::forms.button.soft_delete')  ,
		'save_value' => isset($save_value)? $save_value : 'submit' ,
