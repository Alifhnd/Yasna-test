...
return [
    ...
    */
    ...
    'persian'              => "Fill :attribute with Persian characters.",
    'english'              => "Fill :attribute with English characters.",
    'slug'                 => "Only English words, numeric characters and hyphens in :attribute are acceptable and numbers should not be at the start.",
    "file_exists"          => "The :attribute file does not exist or has been deleted.",
    ...
    'javascript_validation' => [
         ...
         "telephone"            => 'Enter telephone number in 11 digits.',
         "tel_emergency"        => 'Enter emergency telephone number in 11 digits.',
         "postal_code"          => "Enter your correct postal code.",
         "address"              => "Enter your address with Persian characters.",
         "tel"                  => "Enter your telephone number in 11 digits.",
         ...
         "home_postal"          => "Enter home a valid home postal code.",
         ...
         "work_postal"          => "Enter work a valid home postal code.",
         "job"                  => "Enter job title with english characters.",
         "familization"         => "Select familization.",
         "familiarization"      => "Select familization.",
         ...
         'min'                  => 'Text characters are less than minimum.',
         'receiver'             => "Enter receiver correctly.",
    ],
    ...
    'attributes_example' => [
         ...
         "password2"           => "********",
         "security"            => "Example: 15",
         "first_and_last_name" => "Example: Mohamad Ahmandi",
         ...
         "familiarization"     => "Example: Site",
         "motivation"          => "Example: Charitable Activities",
         "alloc_time"          => "Example: 5 days",
         "marital"             => 'Example: Married',
         "home_postal"         => 'Example: 1122334455',
         "work_postal"         => 'Example: 1122334455',
    ],
    ...
    'attributes_placeholder' => [
         ...
         "security"            => "(Digits Only)",
         "first_and_last_name" => "(English Characters)",
         ...
         "home_postal"         => "(10 digits with no dash)",
         "work_postal"         => "(10 digits with no dash)",
    ...
    */
    ...
    'attributes' => [
         ...
         'losed_color_code'             => 'Loosed Part Color',
         'remained_color_code'          => 'Remained Part Color',
         'rules'                        => 'Rules',
         'file_type'                    => 'File Type',
         'submission_work_subject'      => 'Work Title',
         'submission_work_owner_name'   => 'Owner\'s Name',
         ...
         'can_register_card' => "Organ Donation Cart Registration Ability",
    ...
    "http" => [
         ...
         'Error424' => "Sorry, but you need to contact the developers.",
         'Error500' => "An Error occurred in the server.",
    ],
